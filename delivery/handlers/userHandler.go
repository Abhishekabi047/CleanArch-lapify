...
func NewUserhandler(UserUseCase interfaceUseCase.UserUseCase, ProductUseCase interfaceUseCase.ProductUseCase, CartUseCase interfaceUseCase.CartUsecase) *UserHandler {
