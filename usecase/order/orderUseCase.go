...
// // Execute implements interfaceUseCase.OrderUseCase.
// func (*OrderUseCase) Execute(int) (*entity.Order, error) {
// 	panic("unimplemented")
// }


func NewOrder(orderRepo interfaces.OrderRepository, cartRepo interfaces.CartRepository, userRepo interfaces.UserRepository, productRepo interfaces.ProductRepository, razopay *config.Razopay) interfaceUseCase.OrderUseCase {
